...
Promise.{all,allSettled,race,any} will allow to run several promises concurrently and whilst great in many uses cases, it can be quite detrimental in some situations.
    ...
    return {
      ...
      PropertyAccessExpression(node) {
        ...
        const isDangerousPromiseCall =
          ...
          ["all", "race", "allSettled", "any"].includes(node.name.escapedText);
